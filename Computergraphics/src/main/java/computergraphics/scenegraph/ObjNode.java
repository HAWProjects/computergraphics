...
//		for (int i = 0; i < this.mesh.getNumberOfTriangles(); ++i) {
//			TriangleFacet temp = this.mesh.getFacet(i);
//			float normalX = (float) temp.getNormal().get(0);
//			float normalY = (float) temp.getNormal().get(1);
//			float normalZ = (float) temp.getNormal().get(2);
//			Vertex v1 = temp.getHalfEdge().getStartVertex();
//			Vertex v2 = temp.getHalfEdge().getNext().getStartVertex();
//			Vertex v3 = temp.getHalfEdge().getNext().getNext().getStartVertex();
//			gl.glNormal3f(normalX, normalY, normalZ);
//
//			gl.glVertex3f((float) v1.getPosition().get(0), (float) v1.getPosition().get(1),
//					(float) v1.getPosition().get(2));
//
//			gl.glVertex3f((float) v2.getPosition().get(0), (float) v2.getPosition().get(1),
//					(float) v2.getPosition().get(2));
//
//			gl.glVertex3f((float) v3.getPosition().get(0), (float) v3.getPosition().get(1),
//					(float) v3.getPosition().get(2));
//		}
