...
public class HalfEdgeTriangleMesh implements ITriangleMesh {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh#addTriangle(int, int, int)
	 */
	@Override
	...
	private void alternativerVersuch(int vertexIndex1, int vertexIndex2, int vertexIndex3) {
		List<Vertex> tempVList = new ArrayList<>();
		tempVList.add(vList.get(vertexIndex1));
		tempVList.add(vList.get(vertexIndex2));
		tempVList.add(vList.get(vertexIndex3));
			...
			for(TriangleFacet facet: tFList) {
				...
				for(int k = 0; k < 3; k++) {
					if(tempVList.contains(secondHalfEdgeList.get(k).getStartVertex())
							&& tempVList.contains(secondHalfEdgeList.get((k + 1) % 3).getStartVertex())) {
						TriangleFacet tF = new TriangleFacet();
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh#addVertex(main.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh# getNumberOfTriangles()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh# getNumberOfVertices()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh#getVertex(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh#getFacet(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh# computeTriangleNormals()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh# setTextureFilename(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see main.java.computergraphics.datastructures.ITriangleMesh# getTextureFilename()
	 */
	@Override
